export function MouseRightClickIcon({ size = 24, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Right button fill (highlighted) */}
      <path d="M21.25 14V14C21.25 8.89 17.11 4.75 12 4.75V14H21.25Z" fill="currentColor" opacity="0.5" />
      {/* Scroll wheel */}
